...
const MaintenancePage: React.FC<MaintenancePageProps> = ({ 
  ...
  const { getMaintenanceMessage, getMaintenanceEndTime } = useMaintenanceStore();
  ...
  const title = isWebsiteMaintenance 
    ...
    : `${moduleName?.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase())} Module Under Maintenance`;
            ...
            <Card className="bg-gray-50 dark:bg-gray-800/50">
              <CardContent className="pt-6">
                ...
                <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span>All your data is safe and will be available when maintenance is complete</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span>We appreciate your patience during this time</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
