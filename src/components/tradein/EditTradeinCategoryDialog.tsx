...
interface EditTradeinCategoryDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
const EditTradeinCategoryDialog: React.FC<EditTradeinCategoryDialogProps> = ({
  isOpen,
  onClose,
  onUpdateCategory,
  category,
...
export default EditTradeinCategoryDialog;
