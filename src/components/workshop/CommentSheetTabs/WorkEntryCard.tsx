...
interface WorkEntryCardProps {
  ...
  handleFileUpload: (file: File, entryId: string, category: string, description?: string) => Promise<void>;
  uploading: boolean;
}
...
const WorkEntryCard: React.FC<WorkEntryCardProps> = ({
  ...
  const handleWarrantyDocumentUpload = (file: File, entryId: string, warrantyIdx: number) => {
    const mockResult = {
      url: URL.createObjectURL(file),
      key: `warranty-${Date.now()}-${file.name}`,
      description: file.name,
    };

    const updatedWarranties = entry.warranties.map((w: any, i: number) =>
      i === warrantyIdx ? { ...w, document: mockResult } : w
    );
  ...
  const createFileUploadHandler = (category: string, accept: string) => {
    return () => {
      ...
      input.onchange = (e) => {
        ...
        files.forEach(file => handleFileUpload(file, entry.id, category, file.name));
      };
      input.click();
    };
  };
  ...
  return (
    <Card 
      className={`border-l-4 ${entry.completed ? 'border-l-green-500 bg-green-50/50 dark:bg-green-950/20' : 'border-l-blue-500 bg-blue-50/50 dark:bg-blue-950/20'} transition-all duration-200 hover:shadow-lg`}
    >
      <CardHeader className="pb-2">
        <div className="flex justify-between items-start">
          <div className="flex items-center gap-2">
            <Badge variant={entry.completed ? "default" : "secondary"} className="bg-gradient-to-r from-blue-500 to-purple-600 text-white text-xs">
              Entry #{index + 1}
            </Badge>
            <Badge variant="outline" className={`text-xs ${entry.completed ? "border-green-500 text-green-700" : "border-orange-500 text-orange-700"}`}>
      ...
      <CardContent className="space-y-3 pt-0">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={(e) => updateWorkEntry(entry.id, "entry_date", e.target.value)}
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={(e) => updateWorkEntry(entry.id, "entry_time", e.target.value)}
                className="pl-8 h-8 text-xs"
                readOnly={isReadOnly}
              />
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={(e) => updateWorkEntry(entry.id, "technician", e.target.value)}
        ...
        <div className="space-y-1">
          <DateTimePicker
            ...
            onChange={(value) => updateWorkEntry(entry.id, "estimated_time", value)}
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={(e) => updateWorkEntry(entry.id, "parts_cost", e.target.value)}
                  placeholder="0.00"
                  className="pl-8 h-8 text-xs"
                  readOnly={isReadOnly}
                />
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={(e) => updateWorkEntry(entry.id, "labor_cost", e.target.value)}
                  placeholder="0.00"
                  className="pl-8 h-8 text-xs"
                  readOnly={isReadOnly}
                />
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  step="0.01"
                  value={entry.gst}
                  onChange={(e) => updateWorkEntry(entry.id, "gst", e.target.value)}
                  placeholder="0.00"
                  className="pl-8 h-8 text-xs"
                  readOnly={isReadOnly}
                />
          ...
          <div className="space-y-4 border-t pt-3">
                    ...
                    <div key={idx} className="relative group">
                      ...
                      {!isReadOnly && (
                        <Button
                          ...
                          onClick={() => {
                            const updatedImages = entry.images.filter((_: any, i: number) => i !== idx);
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1 min-h-[40px] max-h-[120px] overflow-y-auto">
                  {entry.videos.map((video: any, idx: number) => (
                    <div key={idx} className="flex items-center justify-between p-2 bg-muted/50 rounded border text-xs">
                      ...
                      <div className="flex gap-1 flex-shrink-0">
                        ...
                        {!isReadOnly && (
                          <Button
                            ...
                            size="sm"
                            onClick={() => {
                              const updatedVideos = entry.videos.filter((_: any, i: number) => i !== idx);
                              updateWorkEntry(entry.id, "videos", updatedVideos);
                            }}
                            className="h-6 w-6 p-0"
                          >
                            <X className="h-3 w-3" />
                ...
                <div className="flex items-center justify-between">
                  ...
                  {!isReadOnly && (
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      onClick={createFileUploadHandler("pdfs", ".pdf,.doc,.docx")}
                      className="h-6 text-xs"
                    >
                      <Plus className="h-3 w-3" />
                    </Button>
                      ...
                      <div className="flex gap-1 flex-shrink-0">
                        ...
                        {!isReadOnly && (
                          <Button
                            ...
                            size="sm"
                            onClick={() => {
                              const updatedDocs = entry.pdfs.filter((_: any, i: number) => i !== idx);
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  {!isReadOnly && (
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      onClick={createFileUploadHandler("invoices", ".pdf,.jpg,.png")}
                      className="h-6 text-xs"
                    >
                      <Plus className="h-3 w-3" />
                    </Button>
                ...
                <div className="space-y-1 min-h-[40px] max-h-[100px] overflow-y-auto">
                  {entry.invoices.map((invoice: any, idx: number) => (
                    <div key={idx} className="flex items-center justify-between p-2 bg-green-50 dark:bg-green-950 rounded border text-xs">
                      <div className="flex items-center gap-1 truncate">
                      ...
                      <div className="flex gap-1 flex-shrink-0">
                        ...
                        {!isReadOnly && (
                          <Button
                            ...
                            size="sm"
                            onClick={() => {
                              const updatedInvoices = entry.invoices.filter((_: any, i: number) => i !== idx);
                              updateWorkEntry(entry.id, "invoices", updatedInvoices);
                            }}
                            className="h-6 w-6 p-0"
                          >
                            <X className="h-3 w-3" />
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1 min-h-[40px] max-h-[100px] overflow-y-auto">
                  {entry.warranties.map((warranty: any, idx: number) => (
                    <div key={idx} className="space-y-1 p-2 border rounded bg-muted/20">
                      <div className="grid grid-cols-3 gap-1">
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            updateWorkEntry(entry.id, "warranties", updatedWarranties);
                          }}
                        ...
                        <div className="flex items-center gap-1">
                          <Input
                            ...
                            onChange={(e) => {
                              const updatedWarranties = entry.warranties.map((w: any, i: number) =>
                                i === idx ? { ...w, supplier: e.target.value } : w
                              );
                              updateWorkEntry(entry.id, "warranties", updatedWarranties);
                            }}
                            className="text-xs h-7"
                          ...
                          {!isReadOnly && (
                            <Button
                              ...
                              size="sm"
                              onClick={() => {
                                const updatedWarranties = entry.warranties.filter((_: any, i: number) => i !== idx);
                                updateWorkEntry(entry.id, "warranties", updatedWarranties);
                              }}
                      ...
                      <div className="flex items-center gap-2">
                        {warranty.document ? (
                          <div className="flex items-center gap-1 flex-1">
                            ...
                            <span className="text-xs truncate">{warranty.document.description}</span>
                            <Button
                              type="button"
                              variant="ghost"
                              size="sm"
                              onClick={() => window.open(warranty.document.url, "_blank")}
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                input.onchange = (e) => {
                                  ...
                                  if (file) {
                                    handleWarrantyDocumentUpload(file, entry.id, idx);
                                  }
                                };
                                input.click();
                              }}
            ...
            <div className="space-y-2">
              ...
              <div className="grid gap-2 max-h-[120px] overflow-y-auto">
                {entry.persons.map((person: any, idx: number) => (
                  <div key={idx} className="grid grid-cols-1 md:grid-cols-4 gap-2 p-2 border rounded bg-blue-50/50 dark:bg-blue-950/20">
                    <Input
                      placeholder="Name"
                      value={person.name}
                      onChange={(e) => {
                        const updatedPersons = entry.persons.map((p: any, i: number) =>
                    ...
                    {!isReadOnly && (
                      <Button
                        ...
                        size="sm"
                        onClick={() => {
                          const updatedPersons = entry.persons.filter((_: any, i: number) => i !== idx);
                          updateWorkEntry(entry.id, "persons", updatedPersons);
                        }}
                        className="h-7"
                      >
                  ...
                  <div key={key} className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        updateWorkEntry(entry.id, "quality_check", updatedQualityCheck);
                      }}
                      disabled={isReadOnly}
                      className="h-3 w-3"
                    />
                    <Label htmlFor={`${entry.id}-${key}`} className="text-xs capitalize">
                      {key.replace(/_/g, ' ')}
                      {value && <CheckCircle2 className="h-3 w-3 text-green-500 ml-1 inline" />}
                    </Label>
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                onChange={(e) => updateWorkEntry(entry.id, "comments", e.target.value)}
            ...
            <div className="flex items-center space-x-2 p-2 bg-muted/30 rounded-lg">
              <input
                ...
                onChange={(e) => updateWorkEntry(entry.id, "completed", e.target.checked)}
                disabled={isReadOnly}
                className="h-4 w-4"
              />
              <Label htmlFor={`completed-${entry.id}`} className="flex items-center gap-2 font-medium text-sm">
