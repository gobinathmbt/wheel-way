...
interface CreateVehicleMasterModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
...
const CreateVehicleMasterModal = ({
  isOpen,
  onClose,
  onSuccess,
  vehicleType,
}: CreateVehicleMasterModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await masterVehicleServices.createMasterVehicle(submitData);
...
export default CreateVehicleMasterModal;
