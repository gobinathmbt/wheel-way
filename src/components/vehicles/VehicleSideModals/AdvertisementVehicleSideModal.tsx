...
const AdvertisementVehicleSideModal: React.FC<
  AdvertisementVehicleSideModalProps
> = ({ vehicle, isOpen, onClose, onUpdate, vehicleType }) => {
...
export default AdvertisementVehicleSideModal;
